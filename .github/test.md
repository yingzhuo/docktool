...
OPTIONS:
   --env <env-name>     env name for test, can be passed multiple times
   --file <file-name>   file name for test, can be passed multiple times
   --dir <dir-name>     dir name for test, can be passed multiple times
